...
<p align="center">
  <!-- Backend status -->
  <a href="https://github.com/devrhythm/backend/actions"><img src="https://img.shields.io/github/actions/workflow/status/devrhythm/backend/ci.yml?branch=main&label=Backend%20CI&logo=github&style=flat-square" alt="Backend CI"></a>
  <a href="https://codecov.io/gh/devrhythm/backend"><img src="https://img.shields.io/codecov/c/github/devrhythm/backend?logo=codecov&label=Backend%20Coverage&style=flat-square" alt="Backend Coverage"></a>
  <!-- Frontend status -->
  <a href="https://github.com/devrhythm/frontend/actions"><img src="https://img.shields.io/github/actions/workflow/status/devrhythm/frontend/ci.yml?branch=main&label=Frontend%20CI&logo=github&style=flat-square" alt="Frontend CI"></a>
  <a href="https://codecov.io/gh/devrhythm/frontend"><img src="https://img.shields.io/codecov/c/github/devrhythm/frontend?logo=codecov&label=Frontend%20Coverage&style=flat-square" alt="Frontend Coverage"></a>
  <!-- Tech stack badges -->
  ...
  <!-- Live demo -->
  <a href="https://devrhythm.com"><img src="https://img.shields.io/badge/demo-devrhythm.com-blue?style=flat-square" alt="Website"></a>
</p>
...
The repository is split into two independent applications – backend and frontend.
...
```bash
git clone https://github.com/your-org/devrhythm.git
cd devrhythm/backend
npm install
cp .env.example .env   # edit with your own values (see Environment Variables)
...
<p align="center">
  <!-- <a href="https://devrhythm.com">devrhythm.com</a> · 
