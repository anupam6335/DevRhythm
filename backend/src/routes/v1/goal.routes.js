...
router.post("/", auth, rateLimiters.progressUpdateLimiter, validate(progressValidator.createGoal, "body"), goalController.createGoal);
router.put("/:id", auth, rateLimiters.progressUpdateLimiter, validate(progressValidator.updateGoal, "body"), goalController.updateGoal);
router.post("/:id/increment", auth, rateLimiters.progressUpdateLimiter, validate(progressValidator.incrementGoal, "body"), goalController.incrementGoal);
router.post("/:id/decrement", auth, rateLimiters.progressUpdateLimiter, validate(progressValidator.decrementGoal, "body"), goalController.decrementGoal);
router.put("/:id/progress", auth, rateLimiters.progressUpdateLimiter, validate(progressValidator.setGoalProgress, "body"), goalController.setGoalProgress);
...
router.delete("/:id", auth, rateLimiters.progressUpdateLimiter, validate(progressValidator.deleteGoal, "params"), goalController.deleteGoal);
