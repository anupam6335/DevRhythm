...
const webpageSchema = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: { '@type': 'EntryPoint', urlTemplate: `${SITE_URL}/users?search={search_term_string}` },
...
export default function UsersPage() {
  return (
    <>
      ...
      <Script id="schema-webpage" type="application/ld+json" strategy="beforeInteractive"
