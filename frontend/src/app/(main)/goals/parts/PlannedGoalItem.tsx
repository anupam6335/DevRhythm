...
export default function PlannedGoalItem({ goal, onDelete, onEdit, isDeleting = false }: PlannedGoalItemProps) {
  ...
  // Guard after hooks – return null if goal is missing
  if (!goal) return null;
            ...
            <div className={styles.actions}>
              {onEdit && !isCompleted && (
                <Tooltip content="Edit goal">
                  <button className={styles.actionButton} onClick={handleEdit} disabled={isDeleting}>
                    <FiEdit2 size={14} />
                  </button>
                </Tooltip>
              )}
              {!isCompleted && (
                <Tooltip content="Delete goal">
                  <button className={styles.actionButton} onClick={handleDeleteClick} disabled={isDeleting}>
